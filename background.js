...
const width = 1350;
const height = 500; // Set desired height for the map
...
const projection = d3.geoMercator()
    .center([110, 4.0]) // Center coordinates of Malaysia
    .scale(3500) // Adjust the scale for better map fit
...
d3.json("dataset/states.geojson").then(geoData => {
    ...
    g.selectAll("path")
        ...
        .on("mouseover", function (event, d) {
            ...
            tooltip
                ...
                .html(`<strong>${d.properties.Name}</strong>`); // Show state name in tooltip
        })
    ...
    g.selectAll("text")
        ...
        .text(d => d.properties.Name) // Replace 'Name' with the actual property key in your GeoJSON
